...
import chapeau.bowler_pub.validation
from chapeau.bowler_pub.find import find, is_local
from chapeau.bowler_pub.utils import configured_url, short_id_to_url, uri_to_url
...
from chapeau.bowler_pub.validation import validate
...
class UserCollectionView(KepiView):
    ...
    def activity_get(self, request,
        ...
        from chapeau.bowler_pub.models.collection import Collection, CollectionMember
